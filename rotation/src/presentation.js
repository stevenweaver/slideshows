      ...
      >
        ...
        >
          ...
          <Text textColor="primary">
            HIV genetic sequence data can identify transmission clusters, but
            previous approaches have not distinguished clusters of recent, rapid
            transmission.
          </Text>

          <a href="https://veg.github.io/hivtrace-viz/network.html">Example</a>
        ...
        >
          ...
          <BlockQuote>
              <Quote textSize="36px"> 
                Some clusters reflect transmission that occurred many years in the past, presenting limited opportunities to prevent future cases. By contrast, identifying clusters of recent, rapid transmission offers the opportunity to interrupt ongoing spread.
              </Quote>
          </BlockQuote>
        ...
        >
          ...
          <a href="https://veg.github.io/hivtrace-viz/network.html">Recent and Rapid Demo</a>
        ...
        <Slide transition={['fade']} bgColor="secondary" textColor="primary" bgImage="http://silverback.temple.edu/assets/img/Animals_Monkeys_Angry_gorilla_036459_.jpg" bgDarken="0.7">
          ...
          <Image src="https://cdn.worldvectorlogo.com/logos/ucsd.svg" margin="40px 50px" width="150px" display="inline"/>
